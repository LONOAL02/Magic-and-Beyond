...
public class Curas {
    ...
    public static Item curas50 = new Item("Estus pequeño", "El Frasco de Estus es el objeto restaurativo básico, cura 50 PV", 3, Item.CURACION);
    public static Item curas100 = new Item("Estus mediano", "Mejora de el Frasco de Estus básico, cura 100 PV", 0, Item.CURACION);
    public static Item curas200 = new Item("Estus grande", "Mejora de el Frasco de Estus mediano, cura 200 PV", 0, Item.CURACION);



    public Curas(Item curas50, Item curas100, Item curas200) {
        Curas.curas50 = curas50;
        Curas.curas100 = curas100;
        Curas.curas200 = curas200;
    }
    ...
    public static float curarCantidad(float vidaPj, float vidaMax, float cantidad){
    ...
    public static float getCantidad(String nombre){
        switch (nombre){
            case ("Estus pequeño"):
                return 50;
            case ("Estus mediano"):
